package com.example.understandingofrxjava.rxjava.use;
...
import com.example.understandingofrxjava.rxjava.DownloadActivity;
import com.example.understandingofrxjava.rxjava.use.api.WangAndroidApi;
...
import com.example.understandingofrxjava.rxjava.use.util.HttpUtil;
...
//                })
     ...
     */
    @SuppressLint("CheckResult")
    private void antiShakeActonUpdate1() {
        Button bt_anti_shake = findViewById(R.id.bt_anti_shake);
        RxView.clicks(bt_anti_shake)
